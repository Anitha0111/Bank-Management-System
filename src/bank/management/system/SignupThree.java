...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        r1.setFont(new Font("Railway", Font.BOLD, 20));
        r1.setBackground(Color.WHITE);
        r1.setBounds(100, 180, 200, 30);
        add(r1);
        
        r2 = new JRadioButton("Fixed Deposit Account");
        r2.setFont(new Font("Railway", Font.BOLD, 20));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350, 180, 250, 30);
        add(r2);
        
        r3 = new JRadioButton("Current Account");
        r3.setFont(new Font("Railway", Font.BOLD, 22));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100, 220, 250, 30);
        add(r3);
        
        r4 = new JRadioButton("Recurring Deposing Account");
        r4.setFont(new Font("Railway", Font.BOLD, 22));
        r4.setBackground(Color.WHITE);
        r4.setBounds(350, 220, 360, 30);
        add(r4);
        ...
        JLabel number = new JLabel("xxxx-xxxx-xxxx-2413");
        ...
        submit.setBounds(150, 640, 100, 30);
        submit.addActionListener(this);
        add(submit);
        
        cancel = new JButton("Cencel");
        cancel.setBackground(Color.BLACK);
        cancel.setForeground(Color.WHITE);
        cancel.setFont(new Font("Railway", Font.BOLD, 14));
        cancel.setBounds(350, 640, 100, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            if (r1.isSelected()) {
                ...
                accountType = "Recurring Deposing Account";
            }
            ...
            try{
               if (accountType.equals("")) {
                   JOptionPane.showMessageDialog(null, "Account Type id Recuired");
               } else {
                   Conn conn = new Conn();
